class Car {
    ...
    update(roadBoards,traffic) {
        ...
        if (!this.damage) {
            ...
            this.damage = this.#assesDamage(roadBoards,traffic);
        }
        if (this.sensor) {
            ...
            const ouputs = NeuralNetwork.feedForward(offsets,this.brain);
            ...
            if(this.useBrain){
                ...
                this.controls.reverese =ouputs[3];
            }
        }
    }


    #assesDamage(roadBoards,traffic) {
